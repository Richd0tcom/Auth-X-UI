...
export default function Dashboard() {
  return (
    ...
    <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">Register New App</h2>

    <form>
        <div className="flex  gap-6 mt-4 flex-col">
            <div>
                <label className="text-gray-700 dark:text-gray-200" htmlFor="username">App Name</label>
